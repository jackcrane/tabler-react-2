(function (doc) {
  // Create a proxy for ShadowRoot that supplies documentElement and binds methods.
  let fakeDoc = doc;
  if (doc instanceof ShadowRoot) {
    fakeDoc = new Proxy(doc, {
      get: (target, prop) => {
  ...
  // Use fakeDoc as our document reference.
   ...
   */
  console.log("__Tabler Loaded", document);
  !(function (t) {
      ...
      return (
        d(t, [
          ...
          },
          {
            ...
            value: function (t) {
              return t
                ? ((this._value += t), new S({ inserted: t, rawInserted: t }))
                : new S();
            },
          },
          {
              ...
              if (
                ...
                if (u && null != i) {
                  ...
                  ((u = c.rawInserted === i.toString()) && c.inserted) ||
                    ...
                    i.shift(),
                    (u =
                      (c = this.appendTail(i)).rawInserted === i.toString())),
          ...
          },
          {
            ...
            value: function (t, e, n, i) {
              ...
              this.eager &&
                ((i = M(i)), (s = this.extractInput(0, o, { raw: !0 })));
              ...
              if (this.eager && i !== T && s === this.rawInputValue)
                if (i === D)
                  for (
                    ...
                    l.aggregate(new S({ tailShift: -1 })).aggregate(
                      this.remove(c - 1)
                    );
                else i === B && a.unshift();
            ...
            },
            {
              ...
              value: function () {
                ...
                return this._pushLeft(function () {
                  if (!t.block.isFixed)
                    return (
                      (t.offset = t.block.nearestInputPos(t.offset, F)), !0
                    );
                });
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                return this._pushRight(function () {
                  if (!t.block.isFixed)
                    return (
                      (t.offset = t.block.nearestInputPos(t.offset, T)), !0
                    );
                });
              },
            },
    ...
    (G.DEFAULTS = { lazy: !0, placeholderChar: "_" }),
      (G.STOP_CHAR = "`"),
      (G.ESCAPE_CHAR = "\\"),
      (G.InputDefinition = $),
      (G.FixedDefinition = U),
      ...
      return (
        d(n, [
          ...
          },
          {
            ...
            get: function () {
              return (
                y(p(n.prototype), "isComplete", this) && Boolean(this.value)
              );
            },
          },
          {
        ...
        d(n, [
          ...
          },
          {
            ...
            value: function (t) {
              return (
                t === Date ||
                y(p(n.prototype), "maskEquals", this).call(this, t)
              );
            },
          },
        ]),
    ...
    var nt = (function (t) {
      ...
      function n(t) {
        var i;
        return (
          c(this, n), ((i = e.call(this)).input = t), (i._handlers = {}), i
        );
      }
      return (
        d(n, [
          ...
          d(n, [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  i >= 0 && (e = i + this.thousandsSeparator.length), [t, e]
                );
              },
            },
            {
          ...
          var i = e.rawInputValue,
            s = e.compiledMasks.map(function (s, r) {
              return (
                ...
                { weight: s.rawInputValue.length, index: r }
              );
            });
          return (
            s.sort(function (t, e) {
    ...
    function de(t) {
      ...
      var C,
        S = Object.assign({ position: a }, l && he),
        x =
          !0 === c
            ? (function (t) {
                var e = t.x,
    ...
    var Pe = {
      ...
      fn: function (t) {
        var e = t.state,
          ...
          o = Fe(e, { elementContext: "reference" }),
          a = Fe(e, { altBoundary: !0 }),
          u = Be(o, i),
          l = Be(a, s, r),
          c = Me(u),
          h = Me(l);
            ...
            return (
              (t[n] = (function (t, e, n) {
                ...
                return (
                  (o = o || 0),
                  (a = (a || 0) * s),
                  [vt, mt].indexOf(i) >= 0 ? { x: a, y: o } : { x: o, y: a }
                );
              })(n, e.rects, r)),
              t
            );
        ...
        if (w) {
          if (r) {
            var F,
              ...
              W = oe(0, A[B], V[B]),
              $ = b
                ? A[B] / 2 - L - W - H - S.mainAxis
                : j - W - H - S.mainAxis,
              U = b
                ? -A[B] / 2 + L + W + q + S.mainAxis
                : N + W + q + S.mainAxis,
                ...
                if (ze(e, n)) {
                  ...
                  for (var i = 0; i < a.orderedModifiers.length; i++)
                    if (!0 !== a.reset) {
                      ...
                      "function" == typeof r &&
                        (a =
                          r({ state: a, options: u, name: h, instance: c }) ||
                          a);
                    } else (a.reset = !1), (i = -1);
                }
              }
    ...
    var qe = He(),
      We = He({ defaultModifiers: [ge, Le, fe, qt] }),
      $e = He({ defaultModifiers: [ge, Le, fe, qt, Ie, Oe, je, le, Pe] }),
      Ue = Object.freeze({
        __proto__: null,
        popperGenerator: He,
        detectOverflow: Fe,
    ...
    class Nn extends Pn {
      ...
      close() {
        if (Sn.trigger(this._element, "close.bs.alert").defaultPrevented)
          return;
    ...
    class Wn extends Mn {
      ...
      _handleSwipe() {
        ...
        (this._deltaX = 0),
          e &&
            un(e > 0 ? this._config.rightCallback : this._config.leftCallback);
      }
      _initEvents() {
        this._supportPointerEvents
          ? (Sn.on(this._element, "pointerdown.bs.swipe", (t) =>
              this._start(t)
            ),
    ...
    const si = "show",
      ...
      li = { parent: "(null|element)", toggle: "boolean" };
    class ci extends Pn {
      constructor(t, e) {
        ...
        if (
          (this._config.parent &&
            (t = this._getFirstLevelChildren(
              ...
              .map((t) => ci.getOrCreateInstance(t, { toggle: !1 }))),
    ...
    Sn.on(document, "click.bs.collapse.data-api", ai, function (t) {
      ...
      for (const t of Ln.getMultipleElementsFromSelector(this))
        ci.getOrCreateInstance(t, { toggle: !1 }).toggle();
    }),
      an(ci);
    const hi = "dropdown",
      di = "ArrowUp",
    ...
    class Ti extends Pn {
      ...
      show() {
        ...
        if (
          !Sn.trigger(this._element, "show.bs.dropdown", t).defaultPrevented
        ) {
          if (
            (this._createPopper(),
            "ontouchstart" in document.documentElement &&
      ...
      _completeHide(t) {
        if (
          !Sn.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented
        ) {
    ...
    class Wi extends Mn {
      ...
      activate() {
        this._isActive ||
          ...
          Sn.off(document, Vi),
          Sn.on(document, "focusin.bs.focustrap", (t) =>
    ...
    class Ji extends Pn {
      ...
      show(t) {
        ...
        Sn.trigger(this._element, Yi, { relatedTarget: t }).defaultPrevented ||
          ((this._isShown = !0),
          (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              Sn.trigger(this._element, "shown.bs.modal", { relatedTarget: t });
          },
          this._dialog,
          this._isAnimated()
        );
      ...
      _triggerBackdropTransition() {
        if (
          Sn.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented
        )
          return;
        const t =
    ...
    const ts = "show",
      ...
      os = { backdrop: !0, keyboard: !0, scroll: !1 },
      as = {
        backdrop: "(boolean|string)",
        keyboard: "boolean",
        scroll: "boolean",
    ...
    class us extends Pn {
      ...
      show(t) {
        ...
        if (
          Sn.trigger(this._element, "show.bs.offcanvas", { relatedTarget: t })
            .defaultPrevented
        )
          return;
        (this._isShown = !0),
    ...
    class vs extends Mn {
      ...
      _checkContent(t) {
        for (const [e, n] of Object.entries(t))
          super._typeCheckConfig({ selector: e, entry: n }, ms);
      }
      _setContent(t, e, n) {
    ...
    class Ts extends Pn {
      ...
      _isAnimated() {
        return (
          ...
          (this.tip && this.tip.classList.contains(bs))
        );
      }
      _isShown() {
        ...
        for (const e of t)
          if ("click" === e)
            ...
            Sn.on(this._element, t, this._config.selector, (t) => {
              ...
              (e._activeTrigger["focusin" === t.type ? Es : As] = !0),
                e._enter();
            }),
    ...
    class Ys extends Pn {
      ...
      show() {
        ...
        const e = this._getActiveElem(),
          n = e ? Sn.trigger(e, "hide.bs.tab", { relatedTarget: t }) : null;
        Sn.trigger(t, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.removeAttribute("tabindex"),
                ...
                Sn.trigger(t, "shown.bs.tab", { relatedTarget: e }))
              : t.classList.add(Ws);
          },
          t,
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.setAttribute("aria-selected", !1),
                ...
                Sn.trigger(t, "hidden.bs.tab", { relatedTarget: e }))
    ...
    const Ks = "hide",
      Xs = "show",
      Qs = "showing",
      Zs = { animation: "boolean", autohide: "boolean", delay: "number" },
          ...
          var e,
            ...
            i = {
              ...
              html:
                ...
                e,
              placement:
                null !== (n = t.getAttribute("data-bs-placement")) &&
                void 0 !== n
                  ? n
                  : "auto",
            };
